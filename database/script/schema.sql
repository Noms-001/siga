...
CREATE TABLE type_token (
    id_type_token SERIAL PRIMARY KEY,
    code VARCHAR(100) UNIQUE,
    libelle VARCHAR(255) NOT NULL,
    description TEXT
);
...
CREATE TABLE operation_pta (
    id_operation_pta SERIAL PRIMARY KEY,
    code VARCHAR(100) UNIQUE,
    libelle VARCHAR(255) NOT NULL,
    description TEXT,
    annee INTEGER,
...
CREATE TABLE etape_validation (
    id_etape_validation SERIAL PRIMARY KEY,
...
CREATE TABLE activite_utilisateur (
    id_activite_utilisateur SERIAL PRIMARY KEY,
...
CREATE TABLE valeur_indicateur (
    id_valeur_indicateur SERIAL PRIMARY KEY,
...
CREATE TABLE plan_action (
    id_plan_action SERIAL PRIMARY KEY,
...
CREATE TABLE plan_action_origine (
    id_plan_action INTEGER NOT NULL REFERENCES plan_action(id_plan_action),
    id_origine INTEGER NOT NULL REFERENCES origine(id_origine),
